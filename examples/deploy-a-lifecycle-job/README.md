...
This ready to use example show you how to deploy a lifecycle job from GitHub (and from an image) on AWS. All of that in just a few lines of IaC configuration (compatible with both Terraform and OpenTofu).
