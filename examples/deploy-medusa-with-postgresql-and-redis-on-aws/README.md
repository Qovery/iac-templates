...
This ready to use example show you how to deploy a [Medusa](https://medusajs.com) app with PostgreSQL and Redis on AWS and make it accessible via HTTPS. All of that in just a few lines of IaC configuration (compatible with both Terraform and OpenTofu).
